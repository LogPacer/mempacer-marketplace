...
|---|---|---|
| [memspec](https://github.com/LogPacer/memspec) | `v0.3.0` | Spec-discipline framework — `.memspec` DSL + pure-Rust toolchain + agent layer (writer / scrutinizer / implementer / reviewer / slicer / revisioner / synthesizer) for coupled-state work. |
